...
func reloadImpl() error {
	...
	//Log("reloaded nfs server: " + string(output), nil, "0")
	return nil
}
...
func startImpl() error {
	...
	//Log("started nfs server: " + string(output), nil, "0")
	return nil
}
...
func restartImpl() error {
	...
	Log("restarted nfs server: " + string(output), nil, "0")
	return nil
}
...
func stopImpl() error {
	...
	//Log("stopped nfs server: " + string(output), nil, "0")
	return nil
}
